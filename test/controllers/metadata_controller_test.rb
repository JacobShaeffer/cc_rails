...
class MetadataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create metadatum" do
    assert_difference("Metadatum.count") do
      post metadata_url, params: { metadatum: { metadata_type_id: @metadatum.metadata_type_id, name: @metadatum.name } }
    end
  ...
  test "should update metadatum" do
    patch metadatum_url(@metadatum), params: { metadatum: { metadata_type_id: @metadatum.metadata_type_id, name: @metadatum.name } }
